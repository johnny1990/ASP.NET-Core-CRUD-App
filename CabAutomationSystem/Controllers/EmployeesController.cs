...
namespace CabAutomationSystem.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(CabDbContext context)
        {
            _context = context;
        }
        ...
        {
            var cabDbContext = _context.Employee.Include(e => e.Cab);
        ...
        {
            ViewData["CabId"] = new SelectList(_context.Cab, "CabId", "JourneyPlace");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeName,EmployeeNo,Email,Password,ProjectName,Gender,CabId")] Employee employee)
        {
